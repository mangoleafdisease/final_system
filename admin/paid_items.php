...
try {
    ...
    // Fetch only paid orders, filtered by name if a search keyword is provided
    if ($searchKeyword !== '') {
        $stmt = $pdo->prepare("SELECT * FROM customer_orders WHERE customer_name LIKE ? AND status = 'paid' ORDER BY created_at DESC");
        $stmt->execute(["%$searchKeyword%"]);
    } else {
        $stmt = $pdo->prepare("SELECT * FROM customer_orders WHERE status = 'paid' ORDER BY created_at DESC");
        $stmt->execute();
    }
        ...
        <?php foreach ($orders as $order): ?>
            <div class="order-card">
                <div class="order-header">
                    ...
                    <p><strong class="readyto">Ready to Release</strong></p>
                </div>
                ...
                <div class="order-details">
                    ...
                    <p><strong>Status:</strong> Ready to Release</p>
                </div>
...
<script>
    // Add event listener to confirm updates
